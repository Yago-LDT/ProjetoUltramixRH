...
<head>
  ...
  <title>Excluir Banco de Horas - UltraMix RH</title>
...
<br>
      <div class="input-container">
        <form method="post" id="excluirlogin" action="./.././.././../controle/ControleUsuario.php?ACAO=excluirbancodehoras">
          <label for="excluirid">Banco de horas a ser Excluído</label>
