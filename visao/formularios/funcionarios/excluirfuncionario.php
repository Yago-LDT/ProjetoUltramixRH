...
<head>
  ...
  <title>Excluir Funcionário - UltraMix RH</title>
...
<br>
      <div class="input-container">
        <form method="post" id="excluirfuncionario" action="./.././.././../controle/ControleUsuario.php?ACAO=excluirfuncionario">
          <label for="excluirid">Funcionário a ser Excluído</label>
