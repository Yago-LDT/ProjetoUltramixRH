...
<head>
  ...
  <title>Excluir Folha de Pagamento - UltraMix RH</title>
...
<br>
      <div class="input-container">
        <form method="post" id="excluirlogin" action="./.././.././../controle/ControleUsuario.php?ACAO=excluirfolhapagamento">
          <label for="excluirid">Pagamento a ser Excluído</label>
