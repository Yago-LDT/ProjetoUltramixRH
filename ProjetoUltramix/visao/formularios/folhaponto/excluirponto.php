...
<head>
  ...
  <title>Excluir Ponto - UltraMix RH</title>
  ...
  <div class="login-container">
    <div class="login-box">
      ...
      <div class="input-container">
        <form method="post" id="excluirlogin" action="./.././.././../controle/ControleUsuario.php?ACAO=excluirfolhaponto">
          <label for="excluirid">Folha de ponto a ser Excluído</label>
