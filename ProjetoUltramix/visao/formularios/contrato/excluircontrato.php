...
<head>
  ...
  <title>Excluir Contrato - UltraMix RH</title>
  ...
  <div class="login-container">
    <div class="login-box">
      ...
      <div class="input-container">
        <form method="post" id="excluirlogin" action="./.././.././../controle/ControleUsuario.php?ACAO=excluircontrato">
          <label for="excluirid">Contrato a ser Excluído</label>
